      ...
      {open && (
        <>
          <button
            ...
            className="fixed inset-0 z-40 cursor-default bg-neutral-900/20"
          />
          <div
            role="dialog"
            aria-modal="true"
            aria-labelledby={titleId}
            className="fixed inset-x-4 top-1/2 z-50 max-h-[80vh] -translate-y-1/2 overflow-y-auto rounded-lg border border-neutral-300 bg-[var(--background)] p-6 text-left shadow-[var(--shadow-float)] sm:inset-x-auto sm:left-1/2 sm:w-[min(48rem,calc(100vw-3rem))] sm:-translate-x-1/2 sm:p-8 dark:border-neutral-700"
          >
